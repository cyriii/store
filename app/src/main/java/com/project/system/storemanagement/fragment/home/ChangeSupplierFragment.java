 ...
 * 修改
 */
public class ChangeSupplierFragment extends BaseBackFragment {
    @BindView(R.id.title)
    TextView title;
    ...
    public static ChangeSupplierFragment newInstance(int position, GoodsBean goodsBean) {
        ChangeSupplierFragment fragment = new ChangeSupplierFragment();
    ...
    protected void initView() {
        ...
        toolbar.setTitle("");
        title.setText(getString(R.string.change_supplier));
    ...
    public void onViewClicked() {
        ...
        Client.getApiService().changeSupplier(map)
                ...
                .subscribe(new ApiServiceResult(getComposite()) {
                    ...
                    public void onFinish(BaseBean bean) {
                        ...
                        EventBus.getDefault().post(new ChangeSupplierEvent(position, goodsBean));

...
import com.project.system.storemanagement.event.ChangeSupplierEvent;
...
public class SupplierFragment extends MySupportFragment {
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener((adapter1, view, position) -> {
            ((MainFragment) getParentFragment().getParentFragment()).startBrotherFragment(ChangeSupplierFragment.newInstance(position, adapter.getData().get(position)));
        });
    ...
    private void showDialog(int position) {
        ...
        des.setText(R.string.deleteSupplier);
    ...
    private void deleteGoods(int position, String id) {
        ...
        Client.getApiService().delete("/supplier/" + id)
    ...
    private void getData() {
        ...
        Client.getApiService().suppliers(map)
                .compose(RxsRxSchedulers.<BaseBean>io_main())
                .compose(dialogTransformer.transformer())
    ...
    public void addSupplierEvent(AddSupplierEvent event) {
        page = 1;
        getData();
        refreshLayout.setEnableLoadMore(true);
    }
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void changeSupplierEvent(ChangeSupplierEvent event) {

...
public class StoreFragment extends MySupportFragment {
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener((adapter1, view, position) -> {
            ((MainFragment) getParentFragment().getParentFragment()).startBrotherFragment(ChangeCommodityFragment.newInstance(position, adapter.getData().get(position)));
        });
    ...
    private void showDialog(int position) {
        ...
        des.setText(R.string.deleteGoods);
    ...
    private void deleteGoods(int position, String id) {
        ...
        Client.getApiService().delete("/good/" + id)
    ...
    public void addGoosEvent(AddGoosEvent event) {
        page = 1;
        getData();
        refreshLayout.setEnableLoadMore(true);
    }
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void changeGoosEvent(ChangeGoosEvent event) {

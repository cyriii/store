 ...
 * 添加客户
 */
public class AddCustomerFragment extends BaseBackFragment {
    @BindView(R.id.title)
    TextView title;
    ...
    public void onViewClicked() {
        ...
        if (TextUtils.isEmpty(name)) {
            ToastUtils.showShortToast(getResources().getString(R.string.input_commodity_name));
            return;
        }
        ...
        Client.getApiService().customer(map)
                ...
                .subscribe(new ApiServiceResult(getComposite()) {
                    ...
                    public void onFinish(BaseBean bean) {
                        EventBus.getDefault().post(new AddCustomerEvent());

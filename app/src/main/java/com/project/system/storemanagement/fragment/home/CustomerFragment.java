...
import com.project.system.storemanagement.adapter.CustomerAdapter;
...
import com.project.system.storemanagement.event.AddCustomerEvent;
...
public class CustomerFragment extends MySupportFragment {
    ...
    private void initView() {
        ...
        adapter.setOnItemClickListener((adapter1, view, position) -> {
            ((MainFragment) getParentFragment().getParentFragment()).startBrotherFragment(ChangeCustomerFragment.newInstance(position, adapter.getData().get(position)));
        });
    ...
    private void showDialog(int position) {
        ...
        des.setText(R.string.deleteCustomer);
    ...
    private void deleteGoods(int position, String id) {
        ...
        Client.getApiService().delete("/customer/" + id)
    ...
    private void getData() {
        ...
        searchStr = ((HomeFragment) getParentFragment()).getSearchStr();
    ...
    public void addCustomerEvent(AddCustomerEvent event) {
        page = 1;
        getData();
        refreshLayout.setEnableLoadMore(true);
    }
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void changeCustomerEvent(ChangeCustomerEvent event) {
